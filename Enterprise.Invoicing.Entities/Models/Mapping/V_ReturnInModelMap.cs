...
{
    public class V_ReturnInModelMap : EntityTypeConfiguration<V_ReturnInModel>
    {
        public V_ReturnInModelMap()
        {
            // Primary Key
            this.HasKey(t => new { t.returnNo, t.depId, t.staffId, t.supplierId, t.returnAmount, t.returnCost, t.status, t.valid, t.createDate });
