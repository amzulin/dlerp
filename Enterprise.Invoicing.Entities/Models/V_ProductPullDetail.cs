...
{
    public partial class V_ProductPullDetail
    {
        ...
        public int productdetailSn { get; set; }
        public double productdetailAmount { get; set; }
        public double outProductdetailAmount { get; set; }
    }
}
