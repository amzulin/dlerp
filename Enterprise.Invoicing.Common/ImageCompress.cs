...
namespace Enterprise.Invoicing.Common
{
    ...
    public class ImageCompress
    {
        ...
        /// <returns></returns>
        public static bool Thumbnail(string sFile, string dFile, int height, int width, int flag, ZoomType type)
        {
        ...
        /// <param name="bybili"></param>
        /// <returns></returns>
        public static bool Cut(string frompath, string topath, int height, int width, int bili, bool bybili)
        {
            Image img;
            Bitmap bmp;
            Graphics grap;
            ...
            try
            {
                ...
                if (bybili)//按比例
                {
                    width = Convert.ToInt32(img.Width * bili / 100);
                    height = Convert.ToInt32(img.Height * bili / 100);
                }
    ...
    public class Image64Base
    {
        public static String GetImageStr(string img)
        {
            ...
            try
            {
                ...
                FileStream fs = new FileStream(img + ".txt", FileMode.Create);
